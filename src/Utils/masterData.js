...
export const career_objectives = "Detail-oriented Computer Science graduate pursuing a Master's in Data Science and Spatial Analytics with expertise in Artificial Intelligence, GeoAI, Remote Sensing, and Geospatial Data Analytics. Skilled in developing end-to-end AI applications involving deep learning, computer vision, spatial data processing, and full-stack software development using PyTorch, TorchGeo, FastAPI, Next.js, and modern GIS technologies. Passionate about building scalable geospatial intelligence platforms for Earth Observation, environmental monitoring, and urban analytics through research-driven innovation and robust software engineering.";
...
export const education = [
    {
        ...
        relevant_coursework: "Computer Vision, Machine Learning, Geospatial analytics, Google Earth Engine, ArcGIS Pro, Cybersecurity",
        logo: University
    },
    {
        ...
        score: "8.12 CGPA",
        duration: "2025",
        institution: "Sri Sathya Sai Institute of Higher Learning, Muddenahalli",
        relevant_coursework: "Data Structures, Operating Systems, DBMS, Computer Networks, Software Engineering, Linux(Ubuntu)",
        logo: University
    },
    {
        degree: "Intermediate",
...
export const skills_and_certifications = {
    skills: {
        "Programming Languages": ["C", "C++", "Python", "Java", "HTML", "CSS", "JavaScript", "LaTeX", "PL/pgSQL"],
        "Geospatial Tools": ["Google Earth Engine", "Google Earth Pro", "ArcGIS Pro", "TorchGeo", "Rasterio"],
        "Frameworks & Libraries": ["ReactJS", "Django", "ExpressJS", "NodeJS", "Spring Boot", "Material-UI (MUI)"],
...
export const leadership_and_activities = [
    { role: "Technical Head - Nirvai Club", description: "Led AI-focused initiatives, hackathons, and collaborative research-driven projects." },
    { role: "Placement Team Member - Symbiosis", description: "Managed LinkedIn/Meetup outreach and coordinated with industry professionals for placements." },
    { role: "Vice-President - Digital Enlightenment Club", description: "Conducted computer literacy programs for rural students, improving digital accessibility." },
    { role: "Student Internship Coordinator - IIC", description: "Streamlined internship processes and facilitated student-industry engagement." },
    { role: "Leader - Eco-Einsteins Club", description: "Led sustainability initiatives, reducing paper usage by 20% and improving waste management." },
    { role: "Editor - Multimedia Department", description: "Produced 7+ videos, increasing campus engagement by 60%." },
    { role: "Team Lead - Insaight Department", description: "Led a 5-member team to publish campus magazine, increasing student contributions by 30%." }
];
...
export const projects = [
    {
        ...
        tech_stack: ["Python", "PyTorch", "TorchGeo", "FastAPI", "U-Net", "Next.js", "Docker"],
        avatar: [pythonIcon, reactIcon, dockerIcon], // Placeholder avatars
        image: null, // Placeholder to be updated
        description: "Building an end-to-end geospatial intelligence platform integrating Sentinel-2 Earth Observation data, U-Net and DeepLabV3+, TorchGeo, FastAPI, and GIS analytics for land-cover segmentation, temporal change detection, benchmark evaluation, and interactive visualization."
    },
    {
        title: "CHATTY",
    ...
    },
    {
        ...
        avatar: [cplusplus],
        image: Project3,
        description: "Developed a secure hostel management system using file handling and role-based access control. Focused on modularity, data integrity, and restricted access. Developed a C++ command-line application using file handling techniques to manage financial transactions. The app functions with a file-based database to store and retrieve user data and transaction histories."
    },
    {
        title: "CONTRLZ",
        ...
        avatar: [reactIcon],
        image: Project3,
        description: "Built an IoT-based hostel automation system enabling real-time control of lights and fans through a web dashboard. Enhanced energy efficiency and user convenience. The system integrates with a WeMos D1 Mini microcontroller and relay modules to toggle appliances ON/OFF, schedule operations, and provide real-time status updates."
    },
    {
        title: "Studybud",
        ...
        image: Project2,
        description: "Built a Django web application featuring CRUD operations, utilizing Django Rest Framework for API integration. This project, inspired by Denis Ivy, serves as my first venture into web development. It includes a fully functional REST API that supports API calls for data interaction, providing seamless backend communication."
    }
];
